...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      {/* ─── Footer ─── */}
      <footer className="border-t border-border-light bg-primary-mid">
        <div className="mx-auto max-w-[var(--container-max)] px-6 py-12">
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-display text-sm font-bold tracking-[0.12em] text-text-heading">
                  BSE
                </div>
                <div className="font-mono text-[7px] tracking-[0.25em] text-text-muted uppercase">
                  Benz Service Evolution
                </div>
              </div>
            </div>

            <div className="flex flex-col items-center gap-4 text-sm text-text-muted md:flex-row md:gap-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>@bse-service</span>
              </div>
            </div>
          </div>

          <div className="mt-8 border-t border-border-light pt-6 text-center font-mono text-[11px] text-text-muted">
            © 2026 BSE — Benz Service Evolution. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
